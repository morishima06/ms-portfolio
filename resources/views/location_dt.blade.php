...
<body>
  <div class="wrapper">
    ...
    また、後々運用でき,個人的に多少なり知見があり、画期的なものでなくごくありふれてるサービスで需要がありそうなものを考えアパレルショップ検索アプリにしました。
    ...
    <li>Mysql</li>
    <li class="list_none">&nbsp;&nbsp;&nbsp;&nbsp;- Sequel Ace</li>
...
" alt="">
    ...
    <p>
      ...
      作りたいものに対してどのような技術,データベースやデザインの設計、フォルダ構成といったものを初期段階で選定していくことがとても重要であり、
      明確でなく手探りで調べながら作っていたため途中から噛み合わなくなり、無駄な工程、やり直しが発生してしまいました。<br>
    ...
    <h2>今後の課題</h2>
    <h3>typescriptの導入</h3>
    時間的に学習コストを渋り導入を見送ってしまったが、データベースとのやりとりに必須だと痛感しました。
    <h3>不要なレンダリングを失くす</h3>
    ...
    <p>
      ...
      働きながら制作していく中でとにかく学ぶことが多すぎて時間が全く足りないと感じたのが一番の感想です。<br>
      Awsを導入した際にはインフラの知識も多少なりとも必要になりサブネットマスク、CIDER辺り,パプリックIP..etc<br>
      を理解していくのにも時間が取られ本当に終わりが見えないなと思いました。<br>
      ある程度分かっていたことですが技術の流行りが本当に早いなと思います。<br>
      制作会社に入社する辺りではjqueryがそれなりに使われてましたし、Angularがjsのフレームワーク<br>
      の認識としてありましたが、もはやreact,vueに完全に移り変わってるのかなと思っています。<br>
      また、ビルドツールもwebpackを勉強しましたがviteの方がだいぶ早いということで勉強し直しました。<br>
      あとは、感覚で作るのではなく最低限構造をしっかりと理解したうえで作るのが大事なのかなと思います。<br>
